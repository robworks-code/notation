...
- **Over the size budget**: `~/.claude/CLAUDE.md` above `GLOBAL_TARGET_CHARS`. This is the finding that sets the run's goal - everything else is scored against it. (A project `./CLAUDE.md` is scored separately and far more loosely - most never get mentioned.)
